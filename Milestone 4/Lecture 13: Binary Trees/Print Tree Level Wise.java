...
public class Solution {
	...
	public static void printLevelWise(BinaryTreeNode<Integer> root) {
		...
		while(!pendingNodes.isEmpty()){
			BinaryTreeNode<Integer> fronNode=pendingNodes.poll();
			System.out.print(fronNode.data+":");
			if(fronNode.left!=null){
				System.out.print("L:"+fronNode.left.data+",");
				pendingNodes.add(fronNode.left);
			}
			else{
				System.out.print("L:"+-1+",");
			}
			if(fronNode.right!=null){
				System.out.print("R:"+fronNode.right.data);
				pendingNodes.add(fronNode.right);
		}
			else{
